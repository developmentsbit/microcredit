...
class CreateDraftemployeesalarysetupsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('draftemployeesalarysetups', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('draftemployeesalarysetups');
    }
}
