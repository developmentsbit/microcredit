<?php
    ...
    $select_schema_id=$db->link->query("SELECT * FROM `investmentschemas` WHERE `id`='$schema_id'");
    if($select_schema_id)
    {
...
<head>
    ...
    <title>সাপ্তাহিক ঋণ আদায় শীট</title>
            ...
            <td align="center">
                ...
                <label> 
                    ...
                    <span style="font-size:16px; ">আতা, মাদ্রা, নেছারাবাদ, পিরোজপুর ।<br>
                        ...
                        <b style="font-size:18px; margin-bottom: 5px; ">সাপ্তাহিক ঋণ আদায় শীট</b><br>
                </label>
...
<br>
   ...
   <table  cellpadding="0" cellspacing="0"  style="width:100%;">
            <tr>
                ...
                <td  style="text-align: left;background: #f4f4f4;">স্কিমা নাম:<b> <?php print $fetchSchemaName['id']?> <?php print $fetchSchemaName['investment_name']?></b></td>
...
<table cellpadding="0" cellspacing="0" style="width:100%;">
    <tr>
        ...
        <td style="border-top: 1px #000 solid;border-right: 1px #000 solid;border-bottom: 1px #000 solid;text-align: center;" rowspan="3">&nbsp;বিনিয়োগ আইডি</td>
...
<?php
$selectMember=$db->link->query("SELECT `investor_registrations`.`date`,`registration_id`,`installment_amount`,`members`.`aplicant_name`,`father_name`,`mother_name` FROM `investor_registrations` 
INNER JOIN `members` ON `members`.`member_id`=`investor_registrations`.`member_id` 
WHERE `investor_registrations`.`schema_id`='$schema_id' AND 
`investor_registrations`.`branch_id`='$branch_id' AND `investor_registrations`.`area_id`='$area_id'");
$i=1;
...
<tr>
        ...
        <td style="border-right:1px #000 solid; border-bottom:1px #000 solid; text-align: left; width: 60px; "> &nbsp;<?php print $fetch_info['date'];?></td>      

         <td style="border-right:1px #000 solid; border-bottom:1px #000 solid; text-align: right; "> <?php print intval($fetch_info['installment_amount']);?>&nbsp;</td>
        ...
        <td style="border-right:1px #000 solid; border-bottom:1px #000 solid; "></td>
         ...
         <td style="border-right:1px #000 solid; border-bottom:1px #000 solid; padding: 2px; text-align: center; ">

            <input type="text" name="savings1" id="savings1" value="" style="width:100px; height:25px; " autocomplete="off">
        </td>  
...
<br>
    <table style="width:100%;">
        ...
        <tr >
            <td colspan="3" align="center"><input type="button" value="Save" name="Save" onclick="" style="height:35px; width: 160px; background: green; color: #fff; border-radius:5px;"></td>
        </tr>
    </table>
