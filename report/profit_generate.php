        ...
        function investCollectIonfun()
        {
           ...
           var upper =parseInt($('#upper').val());  
            ...
            var investCollection="investCollection";
                    $.ajax({
                      url:"ajaxProfitgenerate.php",
                      type:"POST",
                      data:{lower:lower,upper:upper,branch_id:branch_id,schema_id:schema_id,admin_id:admin_id,investCollection:investCollection,month1:month1,year:year,date:date},
                      cache:false,
