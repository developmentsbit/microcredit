...
<table cellpadding="0" cellspacing="0"   style="width:100%; margin-right:30px">
            <tr>
                ...
                <td rowspan="2" style="border-left: 1px #000 solid;border-top: 1px #000 solid;border-bottom: 1px #000 solid;text-align: center;border-right: 1px #000 solid;">মুনাফা<br>(<?php print $fetchSchemaName['percantage']?>%)</td>
...
return_deposit -->
    ...
    <td style="border-left: 1px #000 solid;border-bottom: 1px #000 solid;text-align: center;"><?php print $db->custome_date($fetch_info['collection_date']) ?><br><?php print $fetch_info['registration_id'] ?></td>
    <td style="border-left: 1px #000 solid;border-bottom: 1px #000 solid;">&nbsp;<?php print $fetch_info['aplicant_name'] ?></td>
...
<tr>
    ...
    <td style="border-left: 1px #000 solid;border-bottom: 1px #000 solid;  text-align: center;" colspan="3">মোট সদস্য : <?php echo $i-1; ?></td>
    ...
    <td style="border-left: 1px #000 solid;border-right: 1px #000 solid;border-bottom: 1px #000 solid; text-align: right;"><?php  print @$db->my_money_format($totalProfit); ?>/-&nbsp;</td>
