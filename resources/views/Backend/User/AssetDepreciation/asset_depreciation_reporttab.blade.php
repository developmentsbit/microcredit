...
<head>
    ...
    <title>অ্যাসেট ডিপ্রেসিয়েশন স্টেটমেন্ট</title>
</head>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table class="table-bordered w-100 text-center">
                    ...
                    <tr>
                        <td colspan="8">অ্যাসেট ডিপ্রেসিয়েশন স্টেটমেন্ট</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        @php
                        $asset_title_name = DB::table('asset_categoreys')->where('id',$asset_title)->first();
                        @endphp
                        <td>{{ $asset_title_name->asset_title }}</td>
