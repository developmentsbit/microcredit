            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>অ্যাসেট সংক্রান্ত ব্যায় যুক্ত করুন</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{route('add_asset_expense.store')}}" method="POST">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="date form-control-sm form-control @error('date') is-invalid @enderror" id="validationCustomUsername" placeholder="" aria-describedby="inputGroupPrepend" name="date" value="{{old('date')}}">
                                    </div>
                                    @error('date')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="onlyEng form-control-sm form-control @error('taka_ammount') is-invalid @enderror" id="validationCustomUsername" placeholder="" aria-describedby="inputGroupPrepend" name="taka_ammount" value="{{old('taka_ammount')}}">
                                    </div>
                                    @error('taka_ammount')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
