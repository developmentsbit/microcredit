                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">ব্যায়</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('/')}}"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="{{route('add_expense.index')}}">ব্যায়</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <form action="{{route('add_expense.store')}}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="date form-control-sm form-control @error('date') is-invalid @enderror" id="validationCustomUsername" placeholder="" aria-describedby="inputGroupPrepend" name="date" value="{{$today_date}}" required="">
                                    </div>
                                    @error('date')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <select class="js-example-basic-single form-control @error('title_id') is-invalid @enderror" name="title_id" required="">
                                            ...
                                            @php
                                            $incometitle = DB::table("expense_titles")->where("status",1)->get();
                                            @endphp
                                            <option value="">নির্বাচন করুন</option>
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control-sm form-control @error('comment') is-invalid @enderror" id="validationCustomUsername" placeholder="Comment" aria-describedby="inputGroupPrepend" name="comment" value="{{old('comment')}}">
                                    </div>
                                    @error('comment')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
