        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('add_expense_title.update',$data->id)}}" method="POST">
                            @csrf
                            @method('put')
                            <div class="row">
                                ...
                                <div class="col-sm-12 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control-sm form-control @error('title') is-invalid @enderror" id="validationCustomUsername" placeholder="মেনুর নাম" aria-describedby="inputGroupPrepend" name="title" value="{{ $data->title }}">
                                    </div>
                                    @error('title')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
