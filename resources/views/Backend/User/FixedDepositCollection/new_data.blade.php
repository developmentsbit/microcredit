    ...
    <div class="pcoded-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">ফিক্সড ডিপোজিট আদায় ও ফেরত</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('/')}}"><i class="feather icon-home"></i></a></li>
                            {{-- <li class="breadcrumb-item"><a href="{{route('fixeddeposit_collection.index')}}">ফিক্সড ডিপোজিট আদায় ও ফেরত<//a></li> --}}
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h5>ফিক্সড ডিপোজিট আদায় ও ফেরত</</h5>
                            </div>
                    ...
                    <div class="card-body table-responsive">
                        <form form-target="blank" action="{{url('/showNewDepositCollReport')}}" method="post">
                            @csrf
                            <div class="row mb-4">
        ...
        <script>
            function chkAll()
            {
                ...
                {
                    $('input#chkFixedDepoColl').prop('checked',true);
                }
                else
                {
                ...
                if($('input#chkFixedDepoColl').is(':checked'))
                {
        ...
        <script>
            function approveAllData()
            {
                ...
                $('#chkFixedDepoColl:checked').each(function(key){
                    ...
                    $.ajax({
                        ...
                        url : '{{ url('approveAllFixedDepoColl') }}',

                        type : 'POST',

                        data : {fixed_depo_coll_id : id},
