            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>ফিক্সড ডিপোজিট ফেরত আপডেট করুন</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{route('fixeddeposit_return.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')

                            @php
                            $explode = explode('-',$data->return_date);
                            ...
                            <div class="row">
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="date form-control form-control-sm @error('return_date') is-invalid @enderror" aria-describedby="inputGroupPrepend" name="return_date" value="{{$return_date}}">
                                    </div>
                                    @error('return_date')
                                ...
                                <div class="col-sm-6 mb-3">
                                    <label>ডিপোজিট ফেরত পরিমাণ</label><span class="text-danger">*</span>
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm @error('deposit_return_ammount') is-invalid @enderror" aria-describedby="inputGroupPrepend" name="deposit_return_ammount" value="{{$data->deposit_return_ammount}}">
                                    </div>
