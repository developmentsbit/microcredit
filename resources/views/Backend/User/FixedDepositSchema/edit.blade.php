            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>ফিক্সড ডিপোজিট স্কিমা আপডেট করুন</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{route('fixed_deposit_schema.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm @error('fixed_deposit_name') is-invalid @enderror" aria-describedby="inputGroupPrepend" name="fixed_deposit_name" value="{{$data->fixed_deposit_name}}">
                                    </div>
