                    ...
                    <div class="card-body table-responsive">
                        <table class="table" id="myTable">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td>
                                    <input onclick="chkAll()" id="chkNewHOcollection" type="checkbox" name="new_income[]" value="{{$d->id}}">
                                </td>
                                <td>{{ $i++ }}</td>
                                <td>{{ $d->date }}</td>
                                <td>{{ $d->branch_name }}</td>
                               ...
                               <td>
                                ...
                                <a style="float: left;margin-right:10px;" href="{{route('ho_collection.edit',$d->id)}}" class="btn btn-info btn-sm"><i class="feather icon-edit"></i></a>
                            ...
                            <td>
                                <a href="{{url('/approved_newho_collection')}}/{{$d->id}}" class="btn btn-sm btn-dark">Approved</a>
                            </td>
...
<script>
    function chkAll()
    {
        ...
        {
            $('input#chkNewHOcollection').prop('checked',true);
        }
        else
        {
        ...
        if($('input#chkNewHOcollection').is(':checked'))
        {
...
<script>
    function approveAllData()
    {
        ...
        $('#chkNewHOcollection:checked').each(function(key){
            ...
            $.ajax({
                ...
                url : '{{ url('approveAllhoCollection') }}',

                type : 'POST',

                data : {new_ho_collection : id},
