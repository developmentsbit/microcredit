...
<head>
    ...
    <title>H / O প্রদান রিপোর্ট</title>
</head>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table class="table-bordered w-100 text-center">
                    ...
                    <tr>
                        <td colspan="8"><h5 class="p-1">H / O প্রদান রিপোর্ট</h5></td>
                    </tr>
                ...
                <table class="table-bordered w-100 mt-3">
                    ...
                    <thead>
                        <tr>
                            <th>সিরিয়াল</th>
                            <th>তারিখ</th>
                            <th>প্রদানকৃত ব্রাঞ্চ নাম</th>
                            <th>গ্রহীত ব্রাঞ্চ নাম</th>
                            <th>টাকার পরিমাণ</th>
                            <th>বিস্তারিত</th>
                  ...
                  <tbody>
                    ...
                    @php
                     ...
                     $handover_branch = DB::table("branch_infos")->where("id",$d->handover_branch_id)->first();
                     $collection_branch = DB::table("branch_infos")->where("id",$d->collection_branch_id)->first();
                    @endphp
                        ...
                        <tr>
                          <td>{{ $sl++ }}</td>
                          <td>{{ $d->date }}</td>
                          <td>{{ $handover_branch->branch_name }}</td>
                          <td>{{ $collection_branch->branch_name }}</td>
                          <td>{{ $d->amount }}/-</td>
                          <td>{{ $d->details }}</td>
                      </tr>
                      ...
                      <tr>
                        <th colspan="4" style="text-align: right">মোট&nbsp;&nbsp;</th>
                        <td colspan="" style="font-weight: bold;">{{ number_format($total,2) }}</td>
                      </tr>
