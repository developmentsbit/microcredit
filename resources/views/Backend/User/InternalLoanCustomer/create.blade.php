        ...
        <div class="row align-items-center">
          <div class="col-md-12">
            ...
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="{{route('internal_loan_customer.index')}}">অভ্যন্তরীণ লোন গ্রাহক</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header">
            <h5>অভ্যন্তরীণ লোন গ্রাহক যুক্ত করুন</h5>
          </div>
          <div class="card-body">
            <form action="{{route('internal_loan_customer.store')}}" method="POST">
              @csrf
              <div class="row">
                ...
                <div class="col-sm-6 mb-3">
                  <label for="validationCustomUsername">নাম</label><span class="text-danger">*</span>
                  <div class="input-group">
                ...
                <div class="col-sm-6 mb-3">
                  <label for="validationCustomUsername">ফোন</label><span class="text-danger">*</span>
                  <div class="input-group">
