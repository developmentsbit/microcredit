                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('internal_loan_handover.index')}}">অভ্যন্তরীণ লোন প্রদান</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>অভ্যন্তরীণ লোন প্রদান যুক্ত করুন</h5>
                    </div>
                    <div class="card-body">
                        @php
                        $today_date = date('d/m/Y');
                        @endphp
                        <form action="{{route('internal_loan_handover.store')}}" method="POST">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-3">
                                 ...
                                 <div class="col-sm-6 mb-3">
                                    <label for="validationCustomUsername">বাকী লোন</label><span class="text-danger">*</span>
                                    <div class="input-group">
                                        <input type="text" class="onlyEng form-control-sm form-control" id="totalloan" aria-describedby="inputGroupPrepend" readonly="">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="onlyEng form-control-sm form-control @error('ammount') is-invalid @enderror" id="validationCustomUsername" aria-describedby="inputGroupPrepend" name="ammount" value="{{old('ammount')}}">
                                    </div>
                                    @error('ammount')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
