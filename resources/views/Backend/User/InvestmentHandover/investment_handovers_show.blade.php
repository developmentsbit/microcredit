            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        <form form-target="_blank" action="{{url('/showInvestmentHandoverReport')}}" method="post">
                            @csrf
                            <div class="row mb-4">
                            ...
                            <tbody id="table_data">
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      {{--   <a style="float: left;margin-right:10px;" href="{{route('investment_handover.edit',$d->id)}}" class="btn btn-info btn-sm"><i class="feather icon-edit"></i></a> --}}
                                        <form action="{{ route('investment_handover.destroy',$d->id) }}" method="post" onsubmit="showAlert()">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn-sm btn btn-danger"><i class="feather icon-trash"></i></button>
                                        </form>
                                         <a href="{{url('investment_handovers_show_approve')}}/{{$d->id}}" class="btn btn-dark btn-sm">Approve</a>
                                    </td>
            ...
            function approveAllData()
            {
                ...
                $('#chkSavingReg:checked').each(function(key){
                    ...
                    $.ajax({
                        ...
                        url : '{{ url('approve_all_investor_handovers') }}',
    ...
    function loadSavingCollBranch()
    {
        ...
        else
        {
            $.ajax({
                ...
                url : '{{ url('loadInvestmentHnadoverBranch') }}',
    ...
    function loadAreaSavingColl()
    {
        ...
        else
        {
            $.ajax({
                ...
                url : '{{ url('loadAreaInvestmentHandover') }}',
