        ...
        <div class="row align-items-center">
          <div class="col-md-12">
            <div class="page-header-title">
              <h5 class="m-b-10">নতুন ঝুঁকি যুক্ত করুন</h5>
            </div>
            <ul class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{url('/')}}"><i class="feather icon-home"></i></a></li>
              <li class="breadcrumb-item"><a href="javascript:;">নতুন ঝুঁকি যুক্ত করুন</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header">
            <h5>নতুন ঝুঁকি যোগ করুন</h5>
          </div>
          <div class="card-body">
            <form action="{{url('addRiskAmount')}}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="row">
                ...
                <div class="col-sm-5 mb-3">
                  ...
                  <div class="input-group">
                    ...
                    <select class="js-example-basic-single form-control @error('member_id') is-invalid @enderror" name="registration_id" id="registration_id" required="" onchange="getinvestmentamount();getRiskAmount()">
                      <option value="">নির্বাচন করুন</option>
                ...
                <div class="col-sm-3 mb-3">
                  <label>বর্তমান ঝুকির পরিমাণ </label>
                ...
                <div class="col-sm-3 mb-3">
                  <label>নতুন ঝুঁকির পরিমাণ </label>
...
<!-- [ Main Content ] end -->
        ...
        <script>
            ...
            {
                var register_id = $('#registration_id').val();
