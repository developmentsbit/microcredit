                    ...
                    <div class="card-body table-responsive">
                     ...
                     <div class="row mb-4">
                        <div class="input-single-box col-4">
                            ...
                            <select name="branch_id" id="branch_id" class="form-control js-example-basic-single" onchange="loadArea();loadinvestCollBranch()">
                        ...
                        <div class="input-single-box col-4">
                            ...
                            <select name="area_id" id="area_id" class="form-control js-example-basic-single" onchange="loadAreainvestColl()">
                                <option value="">নির্বাচন করুন</option>
                            </select>
                        </div>
                    </div>
