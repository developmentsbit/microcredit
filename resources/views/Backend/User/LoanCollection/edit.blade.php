                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('loan_collection.index')}}"> লোন আদায়</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5> লোন আদায় যুক্ত করুন</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{route('loan_collection.update',$data->id)}}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control-sm form-control @error('ammount') is-invalid @enderror" id="validationCustomUsername" aria-describedby="inputGroupPrepend" name="ammount" value="{{$data->ammount}}">
                                    </div>
                                    @error('ammount')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
