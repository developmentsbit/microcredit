        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('add_member.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <select class="js-example-basic-single form-control @error('area_id') is-invalid @enderror" name="area_id" required="" id="area_id">
                                            ...
                                            <option value="{{ $area->id }}" @if($area->id == $data->area_id) selected @endif>{{ $area->area_name }}</option>
                                            @endforeach
                                            @endif
                                        </select>
                                    </div>
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="date form-control form-control-sm @error('apply_date') is-invalid @enderror" aria-describedby="inputGroupPrepend" name="apply_date" value="{{ $data->apply_date }}" required="">
                                    </div>
                                    @error('apply_date')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm @error('aplicant_name') is-invalid @enderror" aria-describedby="inputGroupPrepend" name="aplicant_name" value="{{ $data->aplicant_name }}" required="">
                                    </div>
                                    @error('aplicant_name')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm @error('husband_wife') is-invalid @enderror" aria-describedby="inputGroupPrepend" name="husband_wife" value="{{ $data->husband_wife }}">
                                    </div>
                                    @error('husband_wife')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm @error('father_name') is-invalid @enderror" aria-describedby="inputGroupPrepend" name="father_name" value="{{ $data->father_name }}">
                                    </div>
                                    @error('father_name')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm @error('mother_name') is-invalid @enderror" aria-describedby="inputGroupPrepend" name="mother_name" value="{{ $data->mother_name }}">
                                    </div>
                                    @error('mother_name')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-sm-6 mb-3">
                                    <label>পেশা</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm @error('occupation') is-invalid @enderror" aria-describedby="inputGroupPrepend" name="occupation" value="{{ $data->occupation }}">
                                    </div>
                                    @error('occupation')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <div class="input-group">
                                        <select class="js-example-basic-single form-control @error('division') is-invalid @enderror" name="division" required="" id="division" onchange="loadDistrict()">
                                            ...
                                            @foreach ($division as $v)
                                                <option @if($v->id == $data->division) selected @endif value="{{$v->id}}">{{$v->division_name}}</option>
                                            @endforeach
                                            @endif
                                        </select>
                                    </div>
                                ...
                                <div class="col-sm-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        <select class="js-example-basic-single form-control @error('district') is-invalid @enderror" name="district" required="" id="district" onchange="loadUpazila()">
                                            ...
                                            <option @if($v->id == $data->district) selected  @endif value="{{$v->id}}">{{$v->district_name}}</option>
                                            @endforeach
                                            @endif
                                        </select>
                                    </div>
                                ...
                                <div class="col-sm-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        <select class="js-example-basic-single form-control @error('upazila') is-invalid @enderror" name="upazila" required="" id="upazila">
                                            ...
                                            <option @if($v->id == $data->upazila) selected  @endif value="{{$v->id}}">{{$v->upazila_name}}</option>
                                            @endforeach
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <img src="{{asset('Backend/images/MemberImage')}}/{{$data->image}}" style="max-height: 50px;">
                                    @error('image')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <img src="{{asset('Backend/images/MemberNid')}}/{{$data->applicant_nid}}" style="max-height: 50px;">
                                    @error('applicant_nid')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <img src="{{asset('Backend/images/MemberImage')}}/{{$data->signature}}" style="max-height: 50px;">
                                    @error('signature')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
