            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>ফিক্সড ডিপোজিট স্টেটমেন্ট রিপোর্ট</h5>
                    </div>
                    <div class="card-body">
                        <form action="report/fixed_deposit_statement.php" method="get">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-sm-3 mb-3">
                                    ...
                                    <div class="input-group">
                                        <select class="js-example-basic-single form-control @error('area_id') is-invalid @enderror" name="area_id" id="area_id" required="" onchange="loadMember()">
                                            <option value="">নির্বাচন করুন</option>
                                        </select>
                                    </div>
                                    @error('area_id')
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <select class="js-example-basic-single form-control @error('member_id') is-invalid @enderror" name="regID" id="member_id" required="">
                                            <option value="">নির্বাচন করুন</option>
            ...
            function loadMember()
            {
                ...
                else
                {
                    $.ajax({
                        ...
                        url : '{{ url('loadFixedDepositMember1') }}',
