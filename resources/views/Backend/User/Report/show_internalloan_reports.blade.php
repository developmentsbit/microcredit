...
<head>
  ...
  <title>Show Internal Loan Statement Reports</title>
</head>
          ...
          <div class="col-md-12">
            ...
            <table class="table-bordered w-100 mt-3">
              ...
              <tbody>
               ...
               @php
               $recieved = DB::table("internal_loan_collections")->where('member_id',$d->id)->sum("ammount");
               $provide  = DB::table("internal_loan_handovers")->where('member_id',$d->id)->sum("ammount");
