...
<head>
    ...
    <title>Investor Register Reports</title>
</head>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table class="table-bordered w-100 text-center">
                    ...
                    <tr>
                        <td colspan="8">বিনিয়োগ রেজিষ্ট্রেশন রিপোর্ট</td>
                    </tr>
                ...
                <table class="table-bordered w-100 mt-3">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>নাম</th>
                            <th>ফোন</th>
                            <th>বিনিয়োগ প্রদানের তারিখ</th>
                            <th>বিনিয়োগ মেয়াদ উত্তীর্ণের তারিখ</th>
                    ...
                    <tbody>
                        ...
                        @foreach($data as $d)
                          ...
                          <tr>
                              ...
                              <td>{{ $d->phone }}</td>
                              <td>{{ $d->investment_start_date }}</td>
                              <td>{{ $d->investment_end_date }}</td>
                              <td>{{ $d->amount }}</td>
                              <td>{{ $d->service_charge }}</td>
                              <td>{{ $d->totalamount }}</td>
                              <td>{{ $d->installment }}</td>
                              <td>{{ $d->installment_amount }}</td>
                          </tr>
