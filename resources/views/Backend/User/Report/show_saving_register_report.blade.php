...
<head>
    ...
    <title>Saving Register Reports</title>
</head>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table class="table-bordered w-100 text-center">
                    <tr>
                        <td colspan="8">সঞ্চয় রেজিষ্ট্রেশন রিপোর্ট</td>
                    </tr>
                    <tr>
                        <th>তারিখ:</th>
                        <td>{{ date('d M Y') }}</td>
                ...
                <table class="table-bordered w-100 mt-3">
                    ...
                    <thead>
                        <tr>
                            <th>সিরিয়াল</th>
                            <th>রেজিষ্ট্রেশন তারিখ</th>
                            <th>রেজিষ্ট্রেশন আইডি</th>
                            <th>নাম</th>
                            <th>ফোন</th>
                            <th>সঞ্চয় প্রদানের তারিখ</th>
                            <th>সঞ্চয় মেয়াদ উত্তীর্ণের তারিখ</th>
                            <th>সঞ্চয় পরিমাণ</th>
                            <th>সার্ভিস চার্জ</th>
                            <th>কিস্তির নং</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{ $d->phone }}</td>
                          <td>{{ $d->savings_handover_date }}</td>
                          <td>{{ $d->savings_exp_date }}</td>
                          <td>{{ $d->savings_ammount }}</td>
                          <td>{{ $d->service_charge }}</td>
                          <td>{{ $d->installment_no }}</td>
                          <td>{{ $d->installment_ammount }}</td>
                      </tr>
