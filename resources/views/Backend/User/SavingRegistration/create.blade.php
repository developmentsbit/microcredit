            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>সঞ্চয় রেজিষ্ট্রেশন করুন</h5>
                    </div>
                    <div class="card-body">
                        @php
                        $today_date = date('d/m/Y');
                        @endphp
                        <form action="{{route('saving_registration.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-sm-4 mb-3">
                                    <label>তারিখ</label><span class="text-danger">*</span>
                                    <div class="input-group">
                                        <input type="text" class="date form-control form-control-sm @error('registration_date') is-invalid @enderror" aria-describedby="inputGroupPrepend" name="registration_date" value="{{$today_date}}">
                                    </div>
                                ...
                                <div class="col-sm-3 mb-3">
                                    ...
                                    <div class="input-group">
                                        <select class="js-example-basic-single form-control @error('schema_id') is-invalid @enderror" name="schema_id" id="schema_id" onchange="getSchemaPer();getSavingSchemaInstallment()">
                                            <option value="">নির্বাচন করুন</option>
                                            @if ($schema)
                                            @foreach ($schema as $view)
                                                <option value="{{$view->id}}">{{$view->deposit_name}}</option>
                                            @endforeach
                                            @endif
                                        </select>
                                    </div>
                                ...
                                {{-- <input type="hidden" id="schema_per"> --}}
                                <div class="col-sm-3 mb-3">
                                    <label>লভ্যাংশের শতকরা পরিমাণ (%)</label><span class="text-danger">*</span>
                                    <div class="input-group">
                                        <input id="schema_per" type="text" class=" form-control form-control-sm @error('profit_percantage') is-invalid @enderror" aria-describedby="inputGroupPrepend" name="profit_percantage" value="{{old('profit_percantage')}}" onkeyup="calCulateData()">
                                    </div>
                                ...
                                <div class="col-sm-3 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input id="installment_ammount" type="text" class=" form-control form-control-sm @error('installment_ammount') is-invalid @enderror" aria-describedby="inputGroupPrepend" name="installment_ammount" value="{{old('installment_ammount')}}" onkeyup="calCulateData()">
                                    </div>
                                ...
                                <div class="col-sm-3 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input id="installment_no" type="text" class=" form-control form-control-sm @error('installment_no') is-invalid @enderror" aria-describedby="inputGroupPrepend" name="installment_no" value="{{old('installment_no')}}" onkeyup="calCulateData()" readonly>
                                    </div>
                                ...
                                <div class="col-sm-3 mb-3">
                                    <label>মোট সঞ্চয় পরিমাণ</label><span class="text-danger">*</span>
                                    <div class="input-group">
                                        <input id="savings_ammount" type="text" class=" form-control form-control-sm @error('savings_ammount') is-invalid @enderror" aria-describedby="inputGroupPrepend" name="savings_ammount" value="{{old('savings_ammount')}}" onkeyup="calCulateData()">
                                    </div>
                                ...
                                <div class="col-sm-3 mb-3">
                                    <label>লভ্যাংশের পরিমাণ</label>
                                    <div class="input-group">
                                        <input type="text" class=" form-control form-control-sm @error('profit_ammount') is-invalid @enderror" aria-describedby="inputGroupPrepend" name="profit_ammount" value="{{old('profit_ammount')}}" id="profit_ammount" onkeyup="calCulateData()">
                                    </div>
                                ...
                                <div class="col-sm-3 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class=" form-control form-control-sm @error('total') is-invalid @enderror" aria-describedby="inputGroupPrepend" name="total" value="{{old('total')}}" id="total" onkeyup="calCulateData()">
                                    </div>
                                    @error('total')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-sm-3 mb-3">
                                    <label>সার্ভিস চার্জ</label><span class="text-danger">*</span>
                                    <div class="input-group">
                                        <input type="number" class=" form-control form-control-sm @error('service_charge') is-invalid @enderror" aria-describedby="inputGroupPrepend" name="service_charge" value="{{old('service_charge')}}">
                                    </div>
                                ...
                                {{-- <div class="col-sm-3 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="date form-control form-control-sm @error('savings_handover_date') is-invalid @enderror" aria-describedby="inputGroupPrepend" name="savings_handover_date" value="{{$today_date}}">
                                    </div>
                                    @error('savings_handover_date')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div> --}}
                                <input type="hidden" name="duration" id="duraiton">
