    ...
    <div class="pcoded-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">সঞ্চয় ফেরত নতুন ডাটা সমূহ</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('/')}}"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="{{route('saving_return.index')}}">সঞ্চয় ফেরত নতুন ডাটা সমূহ</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h5>সঞ্চয় ফেরত নতুন ডাটা সমূহ</h5>
                            </div>
                    ...
                    <div class="card-body table-responsive">
                        <form form-target="_blank" action="{{url('/showNewSavingReturnReport')}}" method="post">
                            @csrf
                            <div class="row mb-4">
        ...
        <script>
            function chkAll()
            {
                ...
                {
                    $('input#chkSavingReturns').prop('checked',true);
                }
                else
                {
                ...
                if($('input#chkSavingReturns').is(':checked'))
                {
        ...
        <script>
            function approveAllData()
            {
                ...
                $('#chkSavingReturns:checked').each(function(key){
                    ...
                    $.ajax({
                        ...
                        url : '{{ url('approveAllSavingReturns') }}',

                        type : 'POST',

                        data : {saving_return_id : id},
    ...
    function loadSavingCollBranch()
    {
        ...
        else
        {
            $.ajax({
                ...
                url : '{{ url('loadSavingReturnBranch') }}',
