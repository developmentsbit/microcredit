            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>সঞ্চয় স্কিমা যুক্ত করুন</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{route('add_saving_schema.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm @error('deposit_name') is-invalid @enderror" aria-describedby="inputGroupPrepend" name="deposit_name" value="{{old('deposit_name')}}">
                                    </div>
                                    @error('deposit_name')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
